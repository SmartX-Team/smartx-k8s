...
`OpenARK KISS` is a part of `OpenARK`, which was designed to be used for research of [GIST's `NetAI` Laboratory](https://netai.smartx.kr/), led by [**Ho Kim**](https://github.com/HoKim98) under professor [**JongWon Kim**](https://netai.smartx.kr/people/professor).
