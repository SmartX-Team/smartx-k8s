    ...
    match match target_spec {
        Target::Service(target_spec) => {
            let child_ctx = self::service::Context {
                ...
                label_lifecycle_post_stop: &ctx.label_lifecycle_post_stop,
                label_lifecycle_pre_start: &ctx.label_lifecycle_pre_start,
                label_parent: &ctx.label_parent,
                label_priority: &ctx.label_priority,
                label_weight: &ctx.label_weight,
                label_weight_penalty: &ctx.label_weight_penalty,
                label_weight_max: &ctx.label_weight_max,
                label_weight_min: &ctx.label_weight_min,
                name: &name,
                namespace,
